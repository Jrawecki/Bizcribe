  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 space-y-12">
      <header className="space-y-4">
        <p className="text-sm uppercase tracking-[0.2em] text-[var(--ceramic)]">About Bizcribe</p>
        ...
        <p className="text-lg text-[var(--ceramic)] leading-relaxed max-w-3xl">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        {pillars.map((pillar) => (
          <div key={pillar.title} className="rounded-2xl bg-white/5 border border-white/10 p-6 shadow-lg">
            ...
            <ul className="space-y-2 text-[var(--ceramic)] leading-relaxed list-disc list-inside">
      ...
      <section className="rounded-2xl bg-white/5 border border-white/10 p-6 shadow-lg space-y-4">
        ...
        <p className="text-[var(--ceramic)] leading-relaxed">
      ...
      <section className="rounded-2xl bg-white/5 border border-white/10 p-6 shadow-lg space-y-4">
        ...
        <ol className="space-y-3 text-[var(--ceramic)] leading-relaxed list-decimal list-inside">
          {steps.map((step) => (
            <li key={step}>{step}</li>
          ))}
        </ol>
